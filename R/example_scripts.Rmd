...
st <- stac_image_collection(it_obj$features, property_filter = function(f){f[['variable']]=='tas' && f[['month']] %in% c(6,7,8)})
...
#This might crash
lc_cube2 |> apply_pixel('1*(data==10)') |> aggregate_space(method="mean", nx=5000, ny=5000) |> plot(col=heat.colors)
```
