...
var=['ocd','phh2o','sand','silt','soc','wv0010','wv0033','wv1500']
...
for v in var:
	for d in depths:
		...
		try:
			...
			item = stac_item.stac_create_item(str(temp_input_path), tif_url, 'SoilGrids - '+v+'-'+d , datetime.fromisoformat('2016-07-04'),collection, properties)
