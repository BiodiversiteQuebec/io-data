		...
		for r in rcps:
			for t in times:
				...
				try:
					...
					item = stac_item.stac_create_item(str(temp_input_path), uri, name, datetime.fromisoformat(t.split('-')[0]+'-01-01'),collection, properties)
...
catalog.save(dest_href='/bqio/stac3/',catalog_type=pystac.CatalogType.SELF_CONTAINED)
