...
file1 = open('/bqio/datasets/CHELSA_files.txt', 'r')
filelist = file1.readlines()

for filenum in filelist:
	try:
		file=filelist[filenum].strip('\n').strip(' ')
...
catalog.save(dest_href='/bqio/stac/',catalog_type=pystac.CatalogType.RELATIVE_PUBLISHED)
